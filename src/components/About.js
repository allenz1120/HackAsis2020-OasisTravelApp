          ...
          <div>
            <div className="row bio">
              ...
              <a
                ...
                href="https://www.linkedin.com/in/brian-jung-b85373198/"
              >
                <img
          ...
          <div>
            <div className="row bio">
              ...
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.linkedin.com/in/harsh-hemlani/"
              >
                <img
                  src={require("./../static/linkedin.svg")}
                  className="logo"
          ...
          <div>
            <div className="row bio">
              ...
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.linkedin.com/in/alexjprior/"
              >
                <img
                  src={require("./../static/linkedin.svg")}
                  className="logo"
          ...
          <div>
            <div className="row bio">
              ...
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.linkedin.com/in/allen-zou/"
              >
                <img
                  src={require("./../static/linkedin.svg")}
                  className="logo"
          ...
          <div>
            <div className="row bio">
              ...
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.linkedin.com/in/ichand/"
              >
                <img
                  src={require("./../static/linkedin.svg")}
                  className="logo"
